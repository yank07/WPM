...
class TestEdit_item(TestCase):
    ...
    def test_edit_item(self):
        ...
        url = reverse('item.views.edit_item', args=[self.item.id])
        diccionario = {'costo': 100, 'descripcion': 'desc', 'complejidad': 25, 'estado': 'ACT', 'observacion': 'asdf'}
